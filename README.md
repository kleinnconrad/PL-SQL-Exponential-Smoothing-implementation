...
* [PL/SQL Exponential Smoothing](#plsql-exponential-smoothing)
  * [Overview](#overview)
...
This repository provides a handmade PL/SQL procedure for calculating simple exponential smoothing directly within an Oracle Database. It is designed for time-series forecasting and trend analysis, applying exponentially diminishing or growing weights to older observations.
